	...
	private var grammarText = """
{
	...
	"surnameStart" : ["Up", "Pants", "Chest", "Pants", "Chest", "Pants", "Chest", "Pants", "Chest", "Pants", "Chest", "Pants", "Chest", "Pants", "Chest", "Pants", "Chest", "West", "Long", "East", "North", "River", "South", "Snith", "Cross", "Aft", "Aver", "Ever", "Down", "Whit", "Rob", "Rod", "Hesel", "Kings", "Queens", "Ed", "Sift", "For", "Farring", "Coven", "Craig", "Cath", "Chil", "Clif", "Grit", "Grand", "Orla", "Prat", "Milt", "Wilt", "Berk", "Draft", "Red", "Black"],
	"surnameEnd" : ["castle", "hammer", "master", "end", "wrench", "bottom", "hammer", "wick", "shire", "gren", "glen", "swith", "bury", "every", "stern", "ner", "brath", "mill", "bly", "ham", "tine", "field", "groat", "sythe", "well", "bow", "bone", "wind", "storm", "horn", "thorne", "cart", "bry", "ton", "man", "watch", "leath", "heath", "ley"],
	"characterType" : ["android", "velociraptor", "dragon", "gorilla", "sasquatch", "alien", "squid", "cuttlefish"],
